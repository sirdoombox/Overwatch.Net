...
{
	public class Soldier76 : IStatGroup
	{
		...
		{
			public int HelixRocketsKillsMostinGame { get; private set; }
			public int HelixRocketsKills { get; private set; }
			public int TacticalVisorKills { get; private set; }
			public int TacticalVisorKillsMostinGame { get; private set; }
			public int BioticFieldsDeployed { get; private set; }
			public int BioticFieldHealingDone { get; private set; }
			public int MeleeFinalBlowsMostinGame { get; private set; }
			public float TacticalVisorKillsAverage { get; private set; }
			public float HelixRocketsKillsAverage { get; private set; }

			public void SendTable(OverwatchDataTable table)
			{
				HelixRocketsKillsMostinGame = table.Stats["Helix Rockets Kills - Most in Game"].OWValToInt();
				HelixRocketsKills = table.Stats["Helix Rockets Kills"].OWValToInt();
				TacticalVisorKills = table.Stats["Tactical Visor Kills"].OWValToInt();
				TacticalVisorKillsMostinGame = table.Stats["Tactical Visor Kills - Most in Game"].OWValToInt();
				BioticFieldsDeployed = table.Stats["Biotic Fields Deployed"].OWValToInt();
				BioticFieldHealingDone = table.Stats["Biotic Field Healing Done"].OWValToInt();
