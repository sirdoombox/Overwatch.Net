...
{
	public class Soldier76 : IHeroStats
	{
		...
		{
			public float HelixRocketsKillsMostInGame { get; private set; }
			public float HelixRocketsKills { get; private set; }
			public float TacticalVisorKills { get; private set; }
			public float TacticalVisorKillsMostInGame { get; private set; }
			public float BioticFieldsDeployed { get; private set; }
			public float BioticFieldHealingDone { get; private set; }
			...
			public void SendTable(OverwatchDataTable table)
			{
				...
				else{ TacticalVisorKillsAverage = 0; }
				...
				else{ HelixRocketsKillsAverage = 0; }
			}
		}
