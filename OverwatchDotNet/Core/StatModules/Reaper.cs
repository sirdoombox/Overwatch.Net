...
{
	public class Reaper : IStatGroup
	{
		...
		{
			public int SoulsConsumed { get; private set; }
			public int DeathBlossomKills { get; private set; }
			public int SoulsConsumedMostinGame { get; private set; }
			public int DeathBlossomKillsMostinGame { get; private set; }
			public float SoulsConsumedAverage { get; private set; }
			public float DeathBlossomKillsAverage { get; private set; }

			public void SendTable(OverwatchDataTable table)
			{
				SoulsConsumed = table.Stats["Souls Consumed"].OWValToInt();
				DeathBlossomKills = table.Stats["Death Blossom Kills"].OWValToInt();
				SoulsConsumedMostinGame = table.Stats["Souls Consumed - Most in Game"].OWValToInt();
				DeathBlossomKillsMostinGame = table.Stats["Death Blossom Kills - Most in Game"].OWValToInt();
