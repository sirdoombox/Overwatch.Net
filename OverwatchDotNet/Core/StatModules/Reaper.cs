...
namespace OverwatchAPI.Data
{
	public class Reaper : IStatGroup
	{
		...
		{
			public float SoulsConsumed { get; private set; }
			public float DeathBlossomKills { get; private set; }
			public float SoulsConsumedMostInGame { get; private set; }
			public float DeathBlossomKillsMostInGame { get; private set; }
			...
			public void SendTable(OverwatchDataTable table)
			{
				...
				else{ SoulsConsumedMostInGame = 0; }
				...
				else{ DeathBlossomKillsMostInGame = 0; }
				...
				else{ DeathBlossomKillsAverage = 0; }
			}
		}
