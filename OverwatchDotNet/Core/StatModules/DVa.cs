	...
	public class DVa : IHeroStats
	{
		...
		public class HeroSpecificStats : IStatModule
		{
			...
			public void SendTable(OverwatchDataTable table)
			{
				...
				if(table.Stats.ContainsKey("Mech Deaths"))
				...
				if(table.Stats.ContainsKey("Mechs Called - Average"))
					MechsCalledAverage = table.Stats["Mechs Called - Average"].OWValToFloat();
				else{ MechsCalledAverage = 0; }
		...
		public class MiscellaneousStats : IStatModule
		{
			...
			public void SendTable(OverwatchDataTable table)
			{
				...
				else{ SelfDestructKillsMostInGame = 0; }
				...
				else{ SelfDestructKillsAverage = 0; }
			}
		}
	}
}