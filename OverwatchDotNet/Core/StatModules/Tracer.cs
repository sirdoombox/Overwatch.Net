...
namespace OverwatchAPI.Data
{
	public class Tracer : IStatGroup
	{
		...
		{
			public int PulseBombKills { get; private set; }
			public int PulseBombKillsMostinGame { get; private set; }
			public int PulseBombsAttachedMostinGame { get; private set; }
			public int PulseBombsAttached { get; private set; }
			...
			{
				PulseBombKills = table.Stats["Pulse Bomb Kills"].OWValToInt();
				PulseBombKillsMostinGame = table.Stats["Pulse Bomb Kills - Most in Game"].OWValToInt();
				PulseBombsAttachedMostinGame = table.Stats["Pulse Bombs Attached - Most in Game"].OWValToInt();
				PulseBombsAttached = table.Stats["Pulse Bombs Attached"].OWValToInt();
