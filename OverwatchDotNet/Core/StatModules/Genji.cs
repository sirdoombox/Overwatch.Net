...
namespace OverwatchAPI.Data
{
	public class Genji : IStatGroup
	{
		...
		{
			public int DragonbladeKills { get; private set; }
			public int DragonbladeKillsMostinGame { get; private set; }
			public int DamageReflected { get; private set; }
			public int DamageReflectedMostinGame { get; private set; }
			public int Dragonblades { get; private set; }
			public int MeleeFinalBlowsMostinGame { get; private set; }
			public float DragonbladeKillsAverage { get; private set; }
			public int DamageReflectedAverage { get; private set; }

			public void SendTable(OverwatchDataTable table)
			{
				DragonbladeKills = table.Stats["Dragonblade Kills"].OWValToInt();
				DragonbladeKillsMostinGame = table.Stats["Dragonblade Kills - Most in Game"].OWValToInt();
				DamageReflected = table.Stats["Damage Reflected"].OWValToInt();
				DamageReflectedMostinGame = table.Stats["Damage Reflected - Most in Game"].OWValToInt();
				Dragonblades = table.Stats["Dragonblades"].OWValToInt();
				...
				DamageReflectedAverage = table.Stats["Damage Reflected - Average"].OWValToInt();
			}
		}
