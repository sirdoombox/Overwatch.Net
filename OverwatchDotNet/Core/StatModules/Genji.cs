...
namespace OverwatchAPI.Data
{
	public class Genji : IStatGroup
	{
		...
		{
			public float DragonbladeKills { get; private set; }
			public float DragonbladeKillsMostinGame { get; private set; }
			public float DamageReflected { get; private set; }
			public float DamageReflectedMostinGame { get; private set; }
			public float Dragonblades { get; private set; }
			public float MeleeFinalBlowsMostinGame { get; private set; }
			public float DragonbladeKillsAverage { get; private set; }
			public float DamageReflectedAverage { get; private set; }

			public void SendTable(OverwatchDataTable table)
			{
				if(table.Stats.ContainsKey("Dragonblade Kills"))
					DragonbladeKills = table.Stats["Dragonblade Kills"].OWValToFloat();
				else{ DragonbladeKills = 0; }
				if(table.Stats.ContainsKey("Dragonblade Kills - Most in Game"))
					DragonbladeKillsMostinGame = table.Stats["Dragonblade Kills - Most in Game"].OWValToFloat();
				else{ DragonbladeKillsMostinGame = 0; }
				if(table.Stats.ContainsKey("Damage Reflected"))
					DamageReflected = table.Stats["Damage Reflected"].OWValToFloat();
				else{ DamageReflected = 0; }
				if(table.Stats.ContainsKey("Damage Reflected - Most in Game"))
					DamageReflectedMostinGame = table.Stats["Damage Reflected - Most in Game"].OWValToFloat();
				else{ DamageReflectedMostinGame = 0; }
				if(table.Stats.ContainsKey("Dragonblades"))
					Dragonblades = table.Stats["Dragonblades"].OWValToFloat();
				else{ Dragonblades = 0; }
				...
				if(table.Stats.ContainsKey("Dragonblade Kills - Average"))
					DragonbladeKillsAverage = table.Stats["Dragonblade Kills - Average"].OWValToFloat();
				else{ DragonbladeKillsAverage = 0; }
				if(table.Stats.ContainsKey("Damage Reflected - Average"))
					DamageReflectedAverage = table.Stats["Damage Reflected - Average"].OWValToFloat();
				else{ DamageReflectedAverage = 0; }
			}
		}
