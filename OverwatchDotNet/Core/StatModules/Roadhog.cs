...
{
	public class Roadhog : IHeroStats
	{
		...
		{
			public float EnemiesHookedMostInGame { get; private set; }
			public float EnemiesHooked { get; private set; }
			public float HooksAttempted { get; private set; }
			public float WholeHogKillsMostInGame { get; private set; }
			public float WholeHogKills { get; private set; }
			public float HookAccuracyBestInGame { get; private set; }
			public float WholeHogKillsAverage { get; private set; }
			public float EnemiesHookedAverage { get; private set; }
			public float HookAccuracy { get; private set; }

			public void SendTable(OverwatchDataTable table)
			{
				if(table.Stats.ContainsKey("Enemies Hooked - Most in Game"))
					EnemiesHookedMostInGame = table.Stats["Enemies Hooked - Most in Game"].OWValToFloat();
				else{ EnemiesHookedMostInGame = 0; }
				if(table.Stats.ContainsKey("Enemies Hooked"))
					EnemiesHooked = table.Stats["Enemies Hooked"].OWValToFloat();
				else{ EnemiesHooked = 0; }
				if(table.Stats.ContainsKey("Hooks Attempted"))
					HooksAttempted = table.Stats["Hooks Attempted"].OWValToFloat();
				else{ HooksAttempted = 0; }
				if(table.Stats.ContainsKey("Whole Hog Kills - Most in Game"))
					WholeHogKillsMostInGame = table.Stats["Whole Hog Kills - Most in Game"].OWValToFloat();
				else{ WholeHogKillsMostInGame = 0; }
				if(table.Stats.ContainsKey("Whole Hog Kills"))
					WholeHogKills = table.Stats["Whole Hog Kills"].OWValToFloat();
				else{ WholeHogKills = 0; }
				if(table.Stats.ContainsKey("Hook Accuracy - Best in Game"))
					HookAccuracyBestInGame = table.Stats["Hook Accuracy - Best in Game"].OWValToFloat();
				else{ HookAccuracyBestInGame = 0; }
				if(table.Stats.ContainsKey("Whole Hog Kills - Average"))
					WholeHogKillsAverage = table.Stats["Whole Hog Kills - Average"].OWValToFloat();
				else{ WholeHogKillsAverage = 0; }
				if(table.Stats.ContainsKey("Enemies Hooked - Average"))
					EnemiesHookedAverage = table.Stats["Enemies Hooked - Average"].OWValToFloat();
				else{ EnemiesHookedAverage = 0; }
				if(table.Stats.ContainsKey("Hook Accuracy"))
					HookAccuracy = table.Stats["Hook Accuracy"].OWValToFloat();
				else{ HookAccuracy = 0; }
			}
		}
