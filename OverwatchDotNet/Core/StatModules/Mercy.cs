...
namespace OverwatchAPI.Data
{
	public class Mercy : IHeroStats
	{
		...
		{
			public float PlayersResurrected { get; private set; }
			public float PlayersResurrectedMostInGame { get; private set; }
			public float PlayersSaved { get; private set; }
			public float MostPlayersSavedInAGame { get; private set; }
			...
			public void SendTable(OverwatchDataTable table)
			{
				...
				else{ PlayersResurrectedMostInGame = 0; }
				...
				else{ MostPlayersSavedInAGame = 0; }
				...
				else{ PlayersResurrectedAverage = 0; }
			}
		}
		...
		{
			public float BlasterKills { get; private set; }
			public float BlasterKillsMostInGame { get; private set; }
			...
			public float BlasterKillsAverage { get; private set; }
