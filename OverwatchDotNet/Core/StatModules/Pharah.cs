...
namespace OverwatchAPI.Data
{
	public class Pharah : IStatGroup
	{
		...
		{
			public int RocketDirectHits { get; private set; }
			public int BarrageKills { get; private set; }
			public int RocketDirectHitsMostinGame { get; private set; }
			public int BarrageKillsMostinGame { get; private set; }
			...
			{
				RocketDirectHits = table.Stats["Rocket Direct Hits"].OWValToInt();
				BarrageKills = table.Stats["Barrage Kills"].OWValToInt();
				RocketDirectHitsMostinGame = table.Stats["Rocket Direct Hits - Most in Game"].OWValToInt();
				BarrageKillsMostinGame = table.Stats["Barrage Kills - Most in Game"].OWValToInt();
		...
		public class AverageStats : IStatModule
		{
			...
			public int ObjectiveKillsAverage { get; private set; }
			...
			public void SendTable(OverwatchDataTable table)
			{
				...
				ObjectiveKillsAverage = table.Stats["Objective Kills - Average"].OWValToInt();
